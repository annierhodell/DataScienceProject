...
#We also modeled Invertivore based on just the beak length to see if it had a similar effect
...
=======
background-image: url(https://images.unsplash.com/photo-1470167494176-c2e966a4eb3d?q=80&w=2342&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D)
#ROC curve for the model of Invertivore predicted just from beak length
>>>>>>> 78bef1be896ddc8205e7a1b9c9aee2afa5fb5f63
...
background-image: url(https://images.unsplash.com/photo-1470167494176-c2e966a4eb3d?q=80&w=2342&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D)
#Prediciting Whether a Bird is an Invertivore
```{r area under the curve for invertivore 2, echo=TRUE}
#Area under curve
birds_predict_I1%>%
  roc_auc(truth = Invertivore_Status, ".pred_Invertivore", event_level = "second")
```
...
- This calculates the area under the curve. 
- Our value for this area 0.6806375 which is greater than 0.5 but lower than 0.74 for the original model
