...
- Niche Tropic which included: Aquatic Predator, Grainivore, Herbivore terrestrial, Nectarivore, Scavenger, Frugivore, Herbivore Aquatic, Interivore, Omnivore and Vertivore


```{r pie chart, echo=FALSE, out.width= "80%", class='centre', fig.align='center'}
...
pie_chart_niche_trophic <- birds_data %>%
  ...
  coord_polar(theta = "y") +
  #scale_fill_manual(values = trophic_colors, name = "Trophic Type") +  # Assign colors and change legend name
  guides(fill = guide_legend(title = "Trophic Type", ncol = 2)) +  # Change legend name
  theme(axis.text = element_blank(),  # Remove axis text
        axis.title = element_blank(),  # Remove axis title
...
- There is not a huge difference between the different general trophics so we decided to look more specifically at the niche trophics
...
- Comparing the average beak data of Invertivores to Not Invertivores
...
class:center, middle
#Our model
modeling whether a bird is an invertivore or not based of the length, depth and width of their beak
