...
```{r fig 21, echo = FALSE, out.width = "75%", fig.align = "right", fig.cap= "figure 2: Bird Measurements Taken"}
...
Depending on the function a beak is required to carry out for a certain diet, the beak shape and size can vary greatly (1). e.g.
...
=======
>>>>>>> e46b92f625cc05d551911f7c5529341c8ff68a70
# Methods 
...
#this is how we found the AUC values and then copied them into the table.
...
Model_table <- tibble(
  "Model" = c("model with 1 variable", "Model with 3 variables"),
  "AUC vlue" = c("0.7395973", "0.6806375"))


```

```{r Model-table, echo = FALSE, results='asis'}
kable(Model_table[1:2, ])
```
