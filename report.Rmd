...
```{r Graph-plot-3, echo=FALSE}
data %>%
  mutate(population_group = case_when(
    population < 300000 ~ "Group 1",
    population > 300000 & population < 600000 ~ "Group 2",
    population > 600000 ~ "Group 3",
    TRUE ~ "Other"))
  ...
  ggplot(mapping = aes(y = reorder(Health_Board_Area_Name, Area_Population), 
                       x = Area_Population/100000))+
  labs(x = "Area Population (in 100,000s)") +
  geom_col()
