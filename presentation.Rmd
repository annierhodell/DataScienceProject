...
kable(head(data_table_1), format = "html")
```
---
...
---
# Taking a Closer Look at Each Year
.pull-left[
- comparing each year, we can see that 2020 had a drastic decrease in a&e attendances.
- naturally this would be due to covid so we want to predict how 2020 would fair if covid hadn't been a factor
]
.pull-right[
```{r plot-graph 2, echo= FALSE}
#Line graph of all the cases from 2015-2023
