...
#Data for the graph of the overall number of attendees for every year

weekly_ae_activity_20231008 <- read_csv("Data/Data Files/weekly_ae_activity_20231008.csv")
HBT_area_names_and_population <- read_csv("Data/Data Files/HBT area names and population.csv")
Treatement_Location_names <- read_csv("Data/Data Files/Treatement Location names.csv")
...
data %>%
  ...
  labs(x = "Date",
       ...
       title = "Number of Attendees From 2015 - 2023")+
